    ...
    public class AppDbContext : IdentityDbContext<User, IdentityRole, string>
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Claim>(entity =>
            {
                ...
                entity.Property(e => e.HourlyRate).HasColumnType("decimal(10,2)").IsRequired();
                ...
                entity.Property(e => e.RejectionReason).HasMaxLength(1000).HasDefaultValue(string.Empty);

                entity.Property(e => e.SubmittedDate).IsRequired().HasDefaultValueSql("GETDATE()"); 
            ...
            modelBuilder.Entity<User>(entity =>
            {
                ...
                entity.Property(e => e.DateCreated).IsRequired().HasDefaultValueSql("GETDATE()"); 
